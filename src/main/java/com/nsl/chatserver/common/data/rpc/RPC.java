package com.nsl.chatserver.common.data.rpc;
...
public class RPC {
    ...
    public static JSONObject getRemoteMethodObject(long longValue, String methodName, Object... args) {
        JSONObject object = new JSONObject();
        try {
            object.put("msg", "method");
            object.put("method", methodName);
            object.put("id", String.valueOf(longValue));
